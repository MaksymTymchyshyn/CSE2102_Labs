...
| File | Lines | Purpose |
|------|-------|---------|
| `my-server.py` | ~220 | Flask server with token endpoints |
| `my-calls.py` | ~270 | Client testing application |
| `test_token_service.py` | ~530 | Unit and functional tests |
| `requirements.txt` | 3 | Python dependencies |
| `demo.sh` | ~60 | Automated demo script |
...
For questions or issues, please refer to the README.md file or contact the instructor.

#!/bin/bash
# Package Lab 10 for submission

echo "=============================================="
echo "Packaging Lab 10 for Submission"
echo "=============================================="
echo ""

# Create submission directory
SUBMISSION_DIR="Lab10_JWT_Submission"
...
cp test_jwt_service.py "$SUBMISSION_DIR/"
...
# Create zip file
ZIP_FILE="Lab10_JWT_Submission.zip"
rm -f "$ZIP_FILE"
...
echo "✓ 2. Unit and functional tests: test_jwt_service.py (25+ tests)"
